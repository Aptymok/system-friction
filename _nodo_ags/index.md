...
<div class="wrap">
  ...
  <div class="limit-box amber" style="margin: 2rem 0 3rem;">
    ...
    <p>Cada vínculo y nota de documento exhibe los mismos datos desde dos enfoques independientes. La narrativa fundó la hipótesis como casode uso del Nodo previo al evento exógeno que la corroboró y validó con métricas reales, con solo 24 horas de latencia entre ambos.</p>
  </div>
  ...
  <a href="{{ site.baseurl }}/caso-estudio/" class="doc-card doc-card--critical" style="display: block; text-decoration: none;">
