...
El ecosistema de *System Friction* se divide estrictamente en dos capas operativas para mantener la pureza metodológica y evitar que los sesgos locales contaminen la teoría general.

**1. La Serie (El Marco Teórico)** Es el motor conceptual y matemático. Documentos designados bajo la nomenclatura `core-` o numéricos simples (01, 02, etc.). Aquí residen las reglas de la dinámica de sistemas, la entropía de Shannon, la latencia institucional y los modelos de gobernanza (MIHM). La Serie es de dominio agnóstico: sus axiomas aplican igual a un acuífero, a un sistema financiero o a una red de telecomunicaciones.
...
* **MIHM:** El framework algorítmico principal diseñado para detectar, predecir y redirigir la entropía sistémica antes del punto de colapso.
* **NTI (Nodo de Trazabilidad Institucional):** La Capa 0 de auditoría. Evalúa la integridad epistémica de los datos. Si detecta manipulación, invalida las decisiones algorítmicas.
* **Latencia Institucional (LDI):** La métrica que cuantifica el tiempo transcurrido entre la emisión de una alerta técnica válida y la ejecución de una acción institucional verificable.
* **Vigilancia Humana por Diseño (VHpD):** Principio arquitectónico que somete cualquier redistribución algorítmica a compuertas de decisión humana.
* **Auto-Mutilación Táctica (AMT):** Mecanismo homeostático de emergencia que sacrifica nodos de baja prioridad para proteger la supervivencia del núcleo ante picos entrópicos.
* **El ecosistema crece por acumulación, no por corrección de consistencia. Las actualizaciones del marco a partir de la versión 1.1 reflejan la integración de nuevas capas de auditoría y refinamiento matemático.**
{: .limit-box }