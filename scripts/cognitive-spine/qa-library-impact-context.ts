...
// /library is a documentary presentation surface over the canonical compact corpus.
// It stays read-only and must not infer private Cognitive Spine state or pretend
