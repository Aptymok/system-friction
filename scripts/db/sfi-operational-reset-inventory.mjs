...
export const OPERATIONAL_RESET_LAYERS = [
  ...
  { id:'reports-commercial-runtime', reason:'Clears generated institutional reports/prospect/commercial runtime, not product definitions or tenant access identities.', tables:['sfi_agent_reports','sfi_reports','sfi_prospect_radar','root_commercial_proposals','root_commercial_events'] },
