...
assert.ok(evolution.includes('latestActionProposals'), 'evolution_proposals_must_deduplicate_and_reenter');
...
assert.ok(cycle.includes('readOpenInstitutionalEvolutionWork(12)'), 'next_cycle_must_read_open_evolution_work');
...
console.log(JSON.stringify({
  ...
  reentry: 'next institutional cycle / ROUTINE_OWNER_RECONCILIATION',
