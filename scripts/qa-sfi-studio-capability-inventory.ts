...
// These three were historically declared missing. The resolved layer is now the
// executable source used by ROOT/readiness and must point to real implementation files.
