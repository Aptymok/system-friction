...
for (const file of [materializerPath, freezePath, blindRuntimePath, blindRoutePath, revealRoutePath, diagnosticRoutePath, componentPath, ...docs]) {
...
console.log(JSON.stringify({
  ...
  boundaryAbsence: 'BLOCKED',
  modelContract: 'FROZEN_FAIL_CLOSED',
  newTables: 0,
  newLabs: 0,
  newAgents: 0,
  newMemorySystems: 0,
