...
check('live ROOT proof targets current auth surfaces and fails closed when the human session fixture is absent',
  ...
  && liveSurfaceProof.includes('valid authenticated ROOT SFI session Cookie header')
  && !liveSurfaceProof.includes('ROOT Supabase cookie header')
