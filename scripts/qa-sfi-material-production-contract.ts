...
console.log(JSON.stringify({
  ok:true, contract:'SFI-MATERIAL-AUDIO-PRODUCTION-GATE-1.0', modes:['VOICE_MUSICALIZE','MASTER_ADJUST'],
  canonicalInstrumentOwner:'CONFIGURED_FOUNDER_INSTRUMENT_BANK', canonicalEngine:'SFZ', canonicalRenderer:'executeSfzAcousticRender',
  scope:'studio:run', maxProductionDurationSeconds:240, velocityAwareRemoteMaterialization:true,
  outputPublication:'WITHDRAW_ON_REOBSERVATION_OR_RETURN_FAILURE', rightsTransfer:false, canonicalPromotion:false,
  realNetworkSampleQa:true, duplicateOwners:0,
}, null, 2));
