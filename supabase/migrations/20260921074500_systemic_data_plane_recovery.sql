create table if not exists public.sfi_continuity_applied_operations (
...
alter table public.sfi_continuity_applied_operations enable row level security;
revoke all on public.sfi_continuity_applied_operations from anon, authenticated;
grant select, insert on public.sfi_continuity_applied_operations to service_role;
