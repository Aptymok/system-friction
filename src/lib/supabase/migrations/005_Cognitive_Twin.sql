...
CREATE INDEX IF NOT EXISTS idx_cognitive_snapshots_node
ON cognitive_snapshots(node_id);

CREATE INDEX IF NOT EXISTS idx_cognitive_snapshots_created
ON cognitive_snapshots(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_episodic_memory_node
ON episodic_memory(node_id);

CREATE INDEX IF NOT EXISTS idx_episodic_memory_salience
ON episodic_memory(salience DESC);
...
CREATE INDEX IF NOT EXISTS idx_contradictions_node
ON cognitive_contradictions(node_id);
...
CREATE INDEX IF NOT EXISTS idx_interaction_telemetry_node
ON interaction_telemetry(node_id);
...
CREATE INDEX IF NOT EXISTS idx_causal_relationships_node
ON causal_relationships(node_id);
...
CREATE INDEX IF NOT EXISTS idx_cognitive_invariants_node
ON cognitive_invariants(node_id);
