...
export const SFI_NAVIGATION: SfiNavItem[] = [
  ...
  { id: 'interface', title: 'User Interface', href: '/field', description: 'Normal-user entry and Mini MOP-H attractor calibration.', area: 'product', status: 'active', public: true, priority: 4 },
