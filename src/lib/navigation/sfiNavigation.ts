...
export const SFI_NAVIGATION: SfiNavItem[] = [
  ...
  },
  {
    ...
    title: 'SFI Console',
    href: '/sfi-console',
    description: 'Tablero operativo central: ciclo, estabilidad, propuestas, ejecucion, outcomes y closed loop.',
    area: 'dashboard',
    status: 'active',
    instrument: 'ROOT',
    priority: 9,
  ...
  {
    id: 'closed-loop',
    title: 'Closed Loop / Evidencia',
    href: '/sfi-console',
    description: 'Flujo propuesta, ejecucion y outcome desde action_proposals, sfi_execution_ledger y sfi_outcomes.',
    area: 'dashboard',
    status: 'active',
    priority: 15,
  },
