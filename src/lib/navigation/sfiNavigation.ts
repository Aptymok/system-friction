...
export const SFI_NAVIGATION: SfiNavItem[] = [
  ...
  { id: 'interface', title: 'User Interface', href: '/interface', description: 'Normal-user entry and Mini MOP-H attractor calibration.', area: 'product', status: 'active', public: true, priority: 4 },
  { id: 'user-observatory', title: 'Mi Observatorio', href: '/interface/observatory', description: 'Private golden-attractor graph, evidence, perturbation and longitudinal trajectory.', area: 'product', status: 'protected', protected: true, priority: 5 },
