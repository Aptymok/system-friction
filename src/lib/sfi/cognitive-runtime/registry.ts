...
const memoryTables = ['sfi_amv_memory', 'graph_nodes'];
...
export const SFI_COGNITIVE_AGENT_REGISTRY: SfiRegisteredCognitiveAgent[] = [
  {
    ...
    readsMemory: ['epistemic_events', 'sfi_amv_memory', 'graph_nodes', 'sfi_predictive_runs'],
...
operationalMode:false,
},
  {
    ...
    simulationAllowed: false,
    humanApprovalRequired: false,
    sourceTables: ['sfi_phenomena', 'sfi_reference_cases', 'graph_nodes'],
    route: null,
    operationalMode: false,
    missingCapability: false,
  },
  ...
  },
  {
    ...
    readsMemory: ['graph_nodes', 'sfi_amv_memory', 'action_proposals'],
    writesMemory: ['epistemic_events'],
    confidenceModel: { method: 'evidence_supported_windowing', calibration: 'observed return windows' },
    authorityLevel: 'advisor',
    simulationAllowed: true,
    humanApprovalRequired: false,
    sourceTables: ['graph_nodes', 'sfi_amv_memory', 'action_proposals'],
    route: null,
    operationalMode: false,
    missingCapability: false,
  },
