...
function routeDisposition(): FounderRouteDisposition[] {
  return [
    ...
    ['/field', 'authenticated user product', 'local field state + existing field persistence when owned-node context exists', 'field', 'keep_as_data_provider', 'Final user operational field.', 'Keep authenticated.'],
    ...
    ['/founder-console', 'former founder surface', '/api/root/founder-state now used by /root', 'operations', 'delete_runtime_route', 'Migrated into /root.', 'Route file deleted.'],
    ['/sfi-console', 'former transitional SFI surface', 'readOperationalConsoleState internal library', 'my_panel', 'delete_runtime_route', 'Function survives as internal read model only.', 'Route file deleted.'],
    ['/world-vector', 'former WorldSpect product surface', '/api/worldspect/* internal providers', 'timeline', 'delete_runtime_route', 'World state moved into /field, /studio and /root diagnostics.', 'Route file deleted.'],
    ['/scorefriction', 'former ScoreFriction product surface', '/api/scorefriction/* internal providers', 'evaluation', 'delete_runtime_route', 'Evidence/music evaluation function moved into /field and /studio.', 'Route file deleted.'],
    ['/moph', 'former MOP-H route', 'MOP-H local field logic + /api/moph/session blocked unless safe', 'field', 'delete_runtime_route', 'Apply MOP-H lives inside /field.', 'Route file deleted.'],
    ['/observatory', 'former observatory shell', 'field components reused by current product contracts', 'field', 'delete_runtime_route', 'Old UX removed as product center.', 'Route file deleted.'],
    ['/campo', 'former field duplicate', 'field source material', 'field', 'delete_runtime_route', 'Duplicate field route removed.', 'Route file deleted.'],
    ['/surfaces', 'former surface index', 'route disposition inside /root', 'route_disposition', 'delete_runtime_route', 'Disposition moved into ROOT.', 'Route file deleted.'],
    ['/instruments', 'former instrument index', 'final route map', 'route_disposition', 'delete_runtime_route', 'Fragmentary index removed from product.', 'Route file deleted.'],
    ['/observatories', 'former AMV scope index', 'internal AMV scope state', 'route_disposition', 'delete_runtime_route', 'Index removed from product.', 'Route file deleted.'],
    ['/cluster-atlas', 'former atlas route', 'derived Atlas in /root and attractor hub in /field', 'atlas', 'delete_runtime_route', 'Atlas no longer separate product route.', 'Route file deleted.'],
    ['/signal-vane', 'former signal route', 'timeline/evidence interpretation in /root and /field', 'timeline', 'delete_runtime_route', 'Signals integrated into final routes.', 'Route file deleted.'],
    ['/cognitive-twin-engine', 'former twin route', 'agent diagnostics in /root and studio memory', 'operations', 'delete_runtime_route', 'Twin diagnostics internalized.', 'Route file deleted.'],
    ['/governance-reality', 'former governance route', 'mutation approvals in /root', 'system_mutation', 'delete_runtime_route', 'Governance moved to ROOT.', 'Route file deleted.'],
    ['/terminal', 'former terminal route', 'internal APIs only', 'operations', 'delete_runtime_route', 'Terminal is not a final product surface.', 'Route file deleted.'],
