...
const capabilities: RootExecutionCapability[] = [
  { id: 'daily', label: 'Run daily observation', state: 'available', endpoint: '/api/root/operational/trigger-observation?job=daily', method: 'POST', description: 'Runs the persisted daily World Vector observation and its governed institutional cycle.' },
  ...
  { id: 'institutional-cycle', label: 'Run Institutional Cycle', state: 'available', endpoint: '/api/root/institutional-cycle', method: 'POST', description: 'Runs the governed SFI institutional cognitive cycle against persisted evidence and the declared institutional attractor.' },
