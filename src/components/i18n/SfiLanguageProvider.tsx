...
// Exact UI phrases only. Canonical SFI identifiers (ROOT, FIELD, RETURN, MIHM,
// Cognitive Twin, WSV, NTI, etc.) are intentionally preserved as proper names.
const UI_PAIRS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['LIVE WORLD OBSERVATORY', 'OBSERVATORIO MUNDIAL EN VIVO'],
  ...
  ['GOVERNANCE QUEUE · COGNITIVE TWIN / ACP', 'GOVERNANCE QUEUE · COGNITIVE TWIN / ACP'],
  ...
  ['CERRAR', 'CLOSE'],
  ['ORIGIN → NOW', 'ORIGEN → AHORA'],
  ['TIME HISTORY', 'HISTORIA TEMPORAL'],
