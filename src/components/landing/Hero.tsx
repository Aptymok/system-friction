...
export function Hero() {
  return (
    <section className="relative flex min-h-[88vh] items-center overflow-hidden bg-paper px-6 pt-20 text-ink">
      <div className="absolute inset-0 opacity-[0.18]" style={{ backgroundImage: 'linear-gradient(#1A1817 1px, transparent 1px), linear-gradient(90deg, #1A1817 1px, transparent 1px)', backgroundSize: '72px 72px' }} />
      <div className="relative mx-auto grid w-full max-w-6xl gap-10 pb-16 lg:grid-cols-[1fr_380px] lg:items-end">
        <div>
        ...
        <div className="border border-ink/10 bg-void p-5 text-paper shadow-terminal">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-gold">Lectura actual</p>
          <div className="mt-5 grid grid-cols-3 gap-3">
            {[
              ...
              <div key={label} className="border border-gold/10 bg-white/[0.03] p-3">
          ...
          <p className="mt-5 font-serif text-lg italic leading-relaxed text-zinc-400">
            “El sistema no persuade. Observa, diagnostica estructura y propone la resolucion minima verificable.”
          </p>
        </div>
      </div>
    </section>
