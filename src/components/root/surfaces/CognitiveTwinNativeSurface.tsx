  ...
  return (
    <RootNativeFrame organ="COGNITIVE TWIN" code={`${lineage.subjectId} / ${lineage.lineageId}`} state={state.implementation.databaseReady ? 'OBSERVABLE' : 'DEGRADED'} generatedAt={state.generatedAt} anchors={anchors} accent="violet">
      ...
      <div className="rn-grid">
        ...
        <section className="rn-panel"><span>SFI INTEGRATION</span><h2>{state.integration.summary.connectedOrganCount}/{state.integration.summary.totalOrganCount}</h2><p>{state.integration.summary.fullyConnected ? 'All declared SFI organs are connected.' : 'Some declared organ connections remain incomplete.'}</p></section>
