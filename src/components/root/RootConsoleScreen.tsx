...
type RootConsoleScreenProps = { initialState: AgenticRootState; worldVector: unknown; governance?: RootHudGovernanceSnapshot };
...
export default function RootConsoleScreen({ initialState, worldVector, governance }: RootConsoleScreenProps) {
