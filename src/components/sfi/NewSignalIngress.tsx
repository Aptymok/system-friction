...
type CycleStatus = { cycleId:string; state:string|null; eventCount:number; evidenceCount:number; cognitiveRunCount:number; returnCount:number; latestEvent?:{eventName?:unknown}|null };
...
export function NewSignalIngress() {
