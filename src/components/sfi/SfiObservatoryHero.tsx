  ...
  return (
    <section id="observatorio" className="sfi-observatory">
      ...
      <style jsx global>{`
        ...
        .reading { right:24px; top:120px; width:260px; border:1px solid rgba(200,169,81,.3); background:rgba(8,7,5,.82); padding:18px; box-shadow:0 0 40px rgba(0,0,0,.45); } .reading header { display:flex; justify-content:space-between; gap:12px; margin-bottom:14px; } .reading span,.ts span { display:block; font-size:9px; letter-spacing:.16em; color:rgba(232,221,195,.5); } .reading b,.ts b { font-size:10px; color:var(--gb); } .reading p { font-size:12px; line-height:1.75; color:rgba(232,221,195,.76); } .reading .muted,.attribution,.degraded-text { color:rgba(232,221,195,.46); font-size:10px; } .degraded-text { color:var(--a); } .cta { display:inline-block; margin-top:12px; color:var(--gb); font-size:10px; letter-spacing:.14em; text-decoration:none; }
