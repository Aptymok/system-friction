...
export function PublicObservatoryUnified({ state }: { state: ObservatoryGoldState }) {
  ...
  return (
    <main className="pou-root">
      ...
      <section id="state" className="pou-hero">
        <div>
      ...
      <section className="pou-vector">
        ...
        <div className="pou-vector-grid">
          {state.vectors.map((vector, index) => (
            <article key={vector.id} data-active={vector.active}>
      ...
      <section id="reading" className="pou-reading">
        <div>
      ...
      <section id="method" className="pou-method">
