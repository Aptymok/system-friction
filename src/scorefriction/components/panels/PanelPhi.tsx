...
export function PanelPhi({ context }: { context: ScoreFrictionPanelContext }) {
  ...
  return (
    <PanelFrame title="Φ_S / RÉGIMEN DEL OBJETO" topo="ZONE-A" className="w-[278px]">
      ...
      <div className="relative flex h-full flex-col items-center justify-center text-center">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2">
          ...
          <MiniReadout label="ξ" value={metrics.xi.toFixed(2)} />
          <MiniReadout label="F_S" value={metrics.fs.toFixed(2)} />
