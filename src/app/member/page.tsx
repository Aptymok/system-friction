    ...
    <main className="min-h-screen bg-[#050504] px-5 py-8 text-[#d8d1c0] md:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-3">
          <article className="border border-[#332c20] bg-[#090908] p-5"><span className="font-mono text-[9px] uppercase tracking-[0.16em] text-[#98896b]">Trayectorias propias</span><strong className="mt-3 block text-3xl font-normal text-[#e4c377]">{workspace.caseCount}</strong><p className="mt-3 text-xs leading-6 text-[#8e8575]">Procesos longitudinales que has abierto en FIELD.</p></article>
          <article className="border border-[#332c20] bg-[#090908] p-5"><span className="font-mono text-[9px] uppercase tracking-[0.16em] text-[#98896b]">Objetos propios</span><strong className="mt-3 block text-3xl font-normal text-[#e4c377]">{workspace.objectCount}</strong><p className="mt-3 text-xs leading-6 text-[#8e8575]">Objetos que has trasladado o cargado en STUDIO.</p></article>
          <article className="border border-[#332c20] bg-[#090908] p-5"><span className="font-mono text-[9px] uppercase tracking-[0.16em] text-[#98896b]">Retornos pendientes</span><strong className="mt-3 block text-3xl font-normal text-[#e4c377]">{workspace.pendingReturnCount}</strong><p className="mt-3 text-xs leading-6 text-[#8e8575]">Puntos de revisión que todavía necesitan observación posterior.</p></article>
        </section>
