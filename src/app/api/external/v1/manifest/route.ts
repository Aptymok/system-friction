...
export async function GET() {
  return NextResponse.json({
    ...
    operations: [
      ...
      { id: 'lab-persist', method: 'POST', path: '/lab', scope: 'lab:write', tenant: 'institutional', body: { operation: 'persist', required: ['title', 'content'], types: { title: 'nonempty string', content: 'nonempty string' }, commandId: 'Optional idempotency key; reread with report(commandId).', researchMetadata: { kind: 'METHOD_LAB_RESEARCH_OBJECT', researchObject: 'Structured research object; preserve external origin and conduct time separately from registration time.' } }, description: 'Persist a source-derived institutional laboratory record without automatic canonical promotion.' },
