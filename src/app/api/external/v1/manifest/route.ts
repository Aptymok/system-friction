  ...
  return NextResponse.json({
    ...
    machineInterfaces: {
      ...
      authenticated: {
        ...
        oauth: { userBoundRequired: true, clientBindingRequired: true, institutionalTenantRequired: true, staticTokenAllowed: false, scopeMode: 'PER_TOOL_CANONICAL_SCOPE', rootScopeCeiling: ['observe','propose','execute','governance:decide','cases:read','cases:write','lab:read','lab:write','lab:run','studio:read','studio:content','studio:run'] },
