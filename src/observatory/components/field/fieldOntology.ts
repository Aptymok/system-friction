...
export const aptymokModuleNodes: FieldOntologyNode[] = [
  ...
  },
  {
    ...
    linkedComponents: ['FieldCommandInput', 'LiturgiaDiagnosticPanel'],
  ...
  },
  {
    ...
    linkedComponents: ['LiturgiaDiagnosticPanel', 'SfiCognitiveField'],
  ...
  },
  {
    ...
    linkedComponents: ['SignalIntake', 'FieldCommandInput'],
    linkedEndpoints: [],
...
export const baseTwinNodes: FieldOntologyNode[] = [
  ...
  },
  {
    ...
    commandMode: 'twin',
    linkedComponents: ['LiturgiaDiagnosticPanel'],
